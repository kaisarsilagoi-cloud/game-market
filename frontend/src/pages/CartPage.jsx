    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <h2 className="text-2xl font-bold">Себетіңіз бос</h2>
          <p className="text-base-content/70">
            Бастау үшін бірнеше тауар қосыңыз
          </p>
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  onClick={() =>
                    updateQuantity(getItemId(item), Math.max(1, qty - 1))
                  }
                >
                ...
                <button
                  className="btn btn-sm btn-ghost"
                  onClick={() =>
                    updateQuantity(getItemId(item), qty + 1)
                  }
                >
      ...
      <div className="card bg-base-100 shadow mt-8 p-6">
        <div className="flex justify-between items-center">
          <span className="text-xl font-bold">Жалпы сома</span>
